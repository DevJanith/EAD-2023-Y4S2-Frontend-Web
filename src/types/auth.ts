...
export type JWTContextType = {
  ...
  signIn: (nic: string, password: string) => Promise<void>;
  signUp: (nic: string, email: string, password: string, userType: number, salutation: number, firstName: string, lastName: string, contactNumber: string, confirmPassword: string) => Promise<void>;
  resetPassword: (email: string) => Promise<void>;
  updateProfile: VoidFunction;
};
